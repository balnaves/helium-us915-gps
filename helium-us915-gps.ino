...
// 0x70.
static const u1_t PROGMEM APPEUI[8] = { 0xC0, 0xEB, 0xAA, 0xF0, 0xE0, 0x56, 0x7C, 0xD9 };
void os_getArtEui (u1_t* buf) {
  memcpy_P(buf, APPEUI, 8);
}

// This should also be in little endian format, see above.
static const u1_t PROGMEM DEVEUI[8] = { 0x6A, 0xEC, 0x6E, 0x38, 0x20, 0xF7, 0xDC, 0x51 };
...
static const u1_t PROGMEM APPKEY[16] = { 0xA3, 0x0F, 0x30, 0x41, 0x5E, 0x43, 0xD1, 0xB4, 0x20, 0x6A, 0x75, 0x4A, 0x3B, 0xA5, 0x32, 0x7A };
...
void do_send(osjob_t* j) {
  ...
  if (LMIC.opmode & OP_TXRXPEND) {
    ...
    LMIC_setTxData2(1, (unsigned char *)&packet, sizeof(struct tx_packet), 0);
